...
export const authToken = (req, res, next) => {
    // Verificamos manualmente token vía Headers, Cookie y req.query
...
// Este middleware permite capturar y personalizar mensajes de error y otros detalles
// en la autenticación vía Passport
