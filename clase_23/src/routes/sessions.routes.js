...
import { createHash, isValidPassword, generateToken, passportCall, authToken } from '../utils.js'
...
// Endpoint para testeo de autenticación jwt con passport, por supuesto podríamos continuar
// utilizando nuestro testeo manual con la función authJwt() (utils.js)
...
// Vemos que esta ruta podrá ser accedida por usuarios de nivel regular hacia arriba.
