...
try {
    ...
    // Como el paquete de rutas de Pets, está generado dentro de una clase
    // que extiende a CustomRouter (ver class.router.js), debemos instanciarlo
    // y obtener el listado de endpoints
